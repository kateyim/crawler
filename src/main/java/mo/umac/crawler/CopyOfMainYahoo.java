...
public class CopyOfMainYahoo {

	public static Logger logger = Logger.getLogger(CopyOfMainYahoo.class.getName());
...
//	public final static String DB_NAME_SOURCE = "../data-experiment/yahoo/ny-prun";
	...
	public static void main(String[] args) {
		...
		debug = false;
		initForServer(false);
		DOMConfigurator.configure(CopyOfMainYahoo.LOG_PROPERTY_PATH);
		shutdownLogs(CopyOfMainYahoo.debug);
		/************************* Crawling Algorithm ***************************/
...
//		AlgoPartition.clusterRegionFile = USDensity.clusterRegionFile;
	...
	public static void initForServer(boolean packaging) {
		if (packaging) {
			...
			CopyOfMainYahoo.LOG_PROPERTY_PATH = "target/log4j.xml";
			...
			CopyOfMainYahoo.LOG_PROPERTY_PATH = "./log4j.xml";
