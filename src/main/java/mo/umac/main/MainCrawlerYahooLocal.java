package mo.umac.main;

import java.util.LinkedList;
import java.util.List;

import mo.umac.crawler.offline.yahoolocal.SliceCrawler;
...
public class MainCrawlerYahooLocal {

	public static Logger logger = Logger.getLogger(MainCrawlerYahooLocal.class.getName());
	...
	public static void initForServer(boolean packaging) {
		if (packaging) {
			...
			MainCrawlerYahooLocal.LOG_PROPERTY_PATH = "target/log4j.xml";
			...
			MainCrawlerYahooLocal.LOG_PROPERTY_PATH = "./src/main/resources/log4j.xml";
